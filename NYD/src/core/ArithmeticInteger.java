 ...
 * ArithmeticInteger
 *
 * an Object wrapper for the primitive type int which allows for basic
 * arithmetic methods.
 *
 * P.A.Crook, 14th Janauary 2004
 **/
public class ArithmeticInteger implements Serializable, Cloneable {
    public int value;

    //constructors
    public ArithmeticInteger(int value) {
        this.value = value;
    }

    public ArithmeticInteger(Integer value) {
    ...
    public Object clone() {
        try {
            ArithmeticInteger aClone = (ArithmeticInteger) super.clone();
            return aClone;
        }
